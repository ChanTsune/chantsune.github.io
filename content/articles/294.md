...
```bash
Flask 1.1.1 (/Users/user/.pyenv/versions/3.7.1/envs/sample/lib/python3.7/site-packages)
    itsdangerous 1.1.0 (/Users/user/.pyenv/versions/3.7.1/envs/sample/lib/python3.7/site-packages)
    Click 7.0 (/Users/user/.pyenv/versions/3.7.1/envs/sample/lib/python3.7/site-packages)
    Werkzeug 0.16.0 (/Users/user/.pyenv/versions/3.7.1/envs/sample/lib/python3.7/site-packages)
Uninstall (y/N)?
```
