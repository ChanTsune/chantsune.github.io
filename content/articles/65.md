...
tRNS はカラータイプ 4, 6 ではすでに完全なαチャンネルが与えられているので禁止されています。  
...
|0x000A(4)|CRC|Chunk TypeとChunk Dataをもとに計算される|
...
|0x000E(4)|CRC|Chunk TypeとChunk Dataをもとに計算される|
...
|--|--|--|
|0x0000(4)|Length|Dataの長さを表す|
|0x0004(4)|Chunk Type|Chunkの種類を表す,ASCII文字でgAMA|
|0x0008(4)|Chunk Data|100000倍したγ値|
|0x000C(4)|CRC|Chunk TypeとChunk Dataをもとに計算される|
...
|0x0028(4)|CRC|Chunk TypeとChunk Dataをもとに計算される|
...
|--|--|--|
|0x0000(4)|Length|Dataの長さを表す|
|0x0004(4)|Chunk Type|Chunkの種類を表す,ASCII文字でsRGB|
|0x0008(1)|Chunk Data|Rendering intent 色の解釈の仕方 |
|0x0009(4)|CRC|Chunk TypeとChunk Dataをもとに計算される|
...
|--|--|--|
|0x0000(4)|Length|Dataの長さを表す|
|0x0004(4)|Chunk Type|Chunkの種類を表す,ASCII文字でiCCP|
...
|0x00--(4)|CRC|Chunk TypeとChunk Dataをもとに計算される|
...
|--|--|--|
|0x0000(4)|Length|Dataの長さを表す|
|0x0004(4)|Chunk Type|Chunkの種類を表す,ASCII文字でtEXt|
...
|--|--|--|
|0x0000(4)|Length|Dataの長さを表す|
|0x0004(4)|Chunk Type|Chunkの種類を表す,ASCII文字で|
|0x0008(1-79)|Chunk Data|キーワード|
|0x00--(1)|Chunk Data|Null separator ヌル文字|
|0x00--(1)|Chunk Data|Compression method|
